        ...
        <div class="row">
			  ...
			  <div class="col-lg-2">
				<div class="input-group">
			      ...
			      <input type="date" name="tbEmpAge1" class="" id="txt_search_tbEmpAge1" >-
			      <input type="date" name="tbEmpAge2" class="" id="txt_search_tbEmpAge2" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
			      <span class="input-group-addon">生日 </span>
			      <input type="text" name="tbEmpBirthday1" class="" id="txt_search_tbEmpBirthday1" >-
			      <input type="text" name="tbEmpBirthday2" class="" id="txt_search_tbEmpBirthday2" >
				</div>
			  </div>
			  <div class="col-lg-2">
				<div class="input-group">
					<span class="input-group-addon">部门</span>
					<select class="form-control" name="txt_search_tbEmpSid" id = "txt_search_tbEmpSid">
					...
					<form id="form_user" method="post" action="reserveUser.htm" enctype="multipart/form-data">
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td>&nbsp;&nbsp;</td>
								<td>性别：</td>
								<td><input type="radio" id="tbEmpSex1" name="tbEmpSex"
								 value="1"	class="" aria-required="true" required/>男</td>
								<td><input type="radio" id="tbEmpSex2" name="tbEmpSex"
								 value="0"	class="" aria-required="true" required/>女</td>
							</tr>
							<tr>
								<td>年龄：</td>
	...
	var TableInit = function () {
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            tbEmpSex: $("#txt_search_tbEmpSex").val(),
	            ...
	            dname: $("#txt_search_tbEmpDid").val(),
	            empFile: $("#txt_search_empFile").val(),
