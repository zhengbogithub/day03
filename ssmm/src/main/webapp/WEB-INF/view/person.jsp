...
<body class="gray-bg">
				...
				<div class="input-group">
					...
					<select class="form-control" name="txt_search_cid" id = "txt_search_cid">
						...
						<c:forEach items="${cList }" var="r">
						 	<option value="${r.cid }">${r.companyName }</option>
						</c:forEach>
                	</select>
				</div>
			 </div>
						...
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
								...
								<td><input type="radio" id="gender1" name="gender"
									class="" aria-required="true" value="1" required/>男</td>
								<td><input type="radio" id="gender2" name="gender"
									class="" aria-required="true" value="0" required/>女</td>
							</tr>
							...
							<tr>
								<td>入职时间：</td>
								<td colspan="4">
									<input type="date" id="cometime" name="cometime"
	...
	<div class="modal fade" id="modal_user_import" role="dialog" aria-labelledby="modal_user_edit" aria-hidden="true">
		<div class="modal-dialog">
			<div class="modal-content">
				<div class="modal-body">
					<form id="form_import" method="post" action="importP.htm" enctype="multipart/form-data">
						<table style="border-collapse:separate; border-spacing:0px 10px;">
							<tr>
							<td>导入文件 </td>
	    ...
	    oTableInit.queryParams = function (params) {
	        var temp = {//这里的键的名字和控制器的变量名必须一致，这边改动，控制器也需要改成一样的
	            ...
	            cid: $("#txt_search_cid").val(),
	             /* cometime: $("#txt_search_cometime").val(),  */
	...
	function initEditUser(getSelection){
		...
		$('#cometime').val(new Date(getSelection.cometime).Format('yyyy-MM-dd'));
